...
ADMINS = [int(i.strip()) for i in os.environ.get("ADMINS").split("5010869192")] if os.environ.get("ADMINS") else []
ADMIN = ADMINS
...
UPDATE_CHANNEL = os.environ.get("UPDATE_CHANNEL", "Ziplinker") # For Force Subscription
