...
• **No** need to share **password or email** to convert links.**
 ...
 Anyone who want to use any **other shortner** instead of ShortnerFly than **contact** at 👉 @ziplinker (all **shortners support** available.)
...
Ex: https://t.me/ziplinker_net / | Ziplinker"""
...
Get API From [{base_site}](https://ziplinker.net/ref/tauheed)
...
**- Message @ziplinker For More Help -**"""
